...
def main():
    parser = argparse.ArgumentParser(description='Classify N-Caltech101')
    ...
    parser.add_argument('-data-dir', type=str, default="/home/hp/DataSet/N-Caltech101/",
    ...
    nCaltech = NCaltech101(root=args.data_dir, data_type='frame', frames_number=args.T, split_by='number')
    # print("************************")
    # print(len(nCaltech))
    # print(type(nCaltech))
    # print(nCaltech.shape)
    # 定义训练集和测试集的划分比例
    train_size = int(0.8 * len(nCaltech))
    test_size = len(nCaltech) - train_size

    # 随机划分训练集和测试集
    train_set, test_set = random_split(nCaltech, [train_size, test_size])
