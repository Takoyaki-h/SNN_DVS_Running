...
cfg = {
'VGG9': [
        [64, 'M'],  # 1 Conv layer + MaxPool
        [128, 'M'],  # 1 Conv layer + MaxPool
        [256, 256, 'M'],  # 2 Conv layers + MaxPool
        [512, 512, 'M'],  # 2 Conv layers + MaxPool
        []
    ],
    'VGG11': [
        [64, 'M'],
...
def vgg9(num_classes=11, dropout=0, **kargs):
    return VGG('VGG9', num_classes, dropout)

def vgg11(num_classes=11, dropout=0, **kargs):
    return VGG('VGG11', num_classes, dropout)


def vgg13(num_classes=11, dropout=0, **kargs):
    return VGG('VGG13', num_classes, dropout)


def vgg16(num_classes=11, dropout=0, **kargs):
    return VGG('VGG16', num_classes, dropout)


def vgg19(num_classes=11, dropout=0, **kargs):
    return VGG('VGG19', num_classes, dropout)


def vgg16_normed(num_classes=11, dropout=0, **kargs):
